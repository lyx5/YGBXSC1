...
<div class="wrapper">
    ...
    <div class="header_user">
        <div class="main_width">
            ...
            <span class="fr">
                <span class="my_insurance"><a href="center/mypolicy.jsp">我的保险</a></span>
                <span class="Backlog"><a href="book_detail.jsp">未完成订单</a></span>
                <span class="message"><a href="center\message.jsp">消息</a></span>
    ...
    <div class="header_nav">
        <div class="main_width">
            ...
            <a href="mypolicy.jsp" class="my_policy fr">我的保单</a>
            <div class="menuBox">
                <ul class="menu">
                    <li><a href="index.jsp">首页</a></li>
                    <li class="special active"><a href="list2.jsp">保险产品</a></li>
                    <li><a href="#">理财中心</a></li>
                    <li><a href="#">关于我们</a></li>
                </ul>
            </div>
            ...
            <div class="first_right fl">
                ...
                <div class="first_info" id="firstInfo">
                    ...
                    <div class="submit_box">
                        <a href="book_notice.jsp" class="submit_buy">立即购买</a>已售<em>8182</em>份
                    </div>
                </div>
            </div>
        </div>
